...
class VehicleDetails extends StatefulWidget {
  ...
  VehicleDetails({required this.previousPage, required this.status});
...
class _VehicleDetailsState extends State<VehicleDetails> {
  late List<VehicleData> _vehicleList;
  ...
  Future<void> _loadSavedData() async {
    ...
    if (savedData != null) {
      setState(() {
        _vehicleList = savedData
            .map((data) => VehicleData.fromMap(jsonDecode(data)))
            .toList();
      });
    }
  }
                      ...
                      final updatedVehicleData = await Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) => VehiEditPage(
                            ...
                            uniqueKey: UniqueKey(),
                            status: widget.status, // Pass status parameter
                          ),
                        ),
                      );
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: () {
           //Navigator.push(
             // context,
             // MaterialPageRoute(
              //    builder: (context) => Add(previousPage: widget.previousPage)),
            //);
          },
