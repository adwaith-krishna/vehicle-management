    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: () {
            // Handle the plus icon press event
            // You can add functionality here, like showing a dialog or navigating to another page
          },
          child: Icon(Icons.add, color: Colors.white), // Plus icon
          backgroundColor: Color.fromARGB(255, 108, 189, 181), // Button color
        ),
      ),
    );
  }
