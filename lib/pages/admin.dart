          ...
          children: <Widget>[
            _buildOptionButton(
              ...
              () => Navigator.of(context).pushReplacement(
                MaterialPageRoute(
                    builder: (context) => VehicleLists(previousPage: 'admin')),
              ),
            ),
            ElevatedButton(
            ...
            _buildOptionButton(
              ...
              () => Navigator.of(context).pushReplacement(
                MaterialPageRoute(
                    builder: (context) => Damage(previousPage: 'admin')),
              ),
            ),
            _buildOptionButton(
              context,
              ...
              () => Navigator.of(context).pushReplacement(
                MaterialPageRoute(
                    builder: (context) => Userman(previousPage: 'admin')),
              ),
            ),
            ElevatedButton(
              style: ElevatedButton.styleFrom(
              ...
              child: Ink(
                ...
                child: Container(
                  ...
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Icon(Icons.car_crash, color: Colors.black, size: 40.0),
                      SizedBox(width: 8),
                      Text(
                        'MANAGE VEHICLES',
                        style: TextStyle(color: Colors.black),
